...
$admincp_actions_normal = array('index', 'setting', 'members', 'admingroup', 'usergroups', 'usertag',
	...
	'tradelog', 'jswizard', 'project', 'counter', 'misc', 'adv','push','pushsend','logs', 'tools', 'portalperm', 'blogrecyclebin',
	...
	'district', 'diytemplate', 'verify', 'nav', 'domain', 'postcomment', 'tag','feedback', 'connect', 'card', 'portalpermission', 'collection', 'membersplit', 'makehtml','threadsadd','threadadd');
