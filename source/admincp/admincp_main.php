...
<div class="mainhd">
<a href="$basescript?frames=yes&action=index" class="logo">Administrator's Control Panel</a>
<div class="uinfo" id="frameuinfo">
<p>$header_welcome, $cpadmingroup <em>{$_G['member']['username']}</em> [<a href="$basescript?action=logout" target="_top">$header_logout</a>]&nbsp;&nbsp;|&nbsp;&nbsp;<a href="index.php" target="_blank">$header_bbs</a></p>
...
<script type="text/JavaScript">
	...
	function uc_modify_sid(sid) {
		$('header_uc').href = '$uc_api_url/eyun_admins.php?m=frame';
	}
