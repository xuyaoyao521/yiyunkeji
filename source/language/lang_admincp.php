...
(
	...
	'subscribe_comsenz_email' => '填写您的邮件地址，订阅官方产品动态、安全提醒、官方新闻',
	...
	'upgrade_right_now' => '您目前使用的程序有新版本发布，请及时升级<span>在线升级</span>',
	...
	'report_tips' => '<li>可以根据举报真实情况，给举报者加减积分，<a href="eyun_admins.php?action=setting&operation=credits" target="_blank">设置用户举报奖惩使用的积分</a></li><li>多人举报时奖惩第一个举报人。</li>',
	...
	'home_database_size' => '当前数据库统计',
	'home_attach_size' => '当前附件统计',
	...
	'setting_basic_boardlicensed_comment' => '选择“是”将在页脚显示商业授权用户链接，链接将指向官方网站，用户可通过此链接验证其所使用的是否经过商业授权',
	...
	'setting_access_register_name_comment' => '设置站点注册地址 mod 值，默认为“register”，修改名称有利于防止灌水软件，有别于X 之前的版本更改了此设置，不需要修改任何文件名称，只在此修改即可',
...
',
	...
	'setting_attach_image_lib_comment' => '请选择用来处理缩略图和水印的图像处理库。GD 是最广泛的处理库但是使用的系统资源较多。ImageMagick 速度快系统资源占用少，但需要服务器安装 ImageMagick 扩展。如果您的服务器有条件安装此程序，请到 <a href="http://www.imagemagick.org" target="_blank">http://www.imagemagick.org</a> 下载',
	...
	'setting_search_srchhotkeywords_disabled' => '<strong>您已开启纵横搜索服务，搜索相关设置请到 <a href="eyun_admins.php?action=cloud&operation=search">云平台->纵横搜索</a> 设置</strong>',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'setting_uc_key_comment' => '通信密钥用于在 UCenter 和之间传输信息的加密，可包含任何字母及数字，请在 UCenter 与设置完全相同的通讯密钥，以确保两套系统能够正常通信',
	...
	'forums_edit_basic_description_comment' => '将显示于版块名称的下面，提供对本版块的简短描述<br />支持内置的代码',
	'forums_edit_basic_rules' => '本版块规则',
	'forums_edit_basic_rules_comment' => '显示于主题列表页的当前版块规则，留空为不显示<br />支持内置的代码',
	...
	'threadtype_edit_vars_type_video' => '上传视频(video)',
	...
	'styles_edit_visual_text' => '<p id="sp_tabletext" style="margin: 0; line-height: 1.6em; color: #444;"><a id="sp_link" href="http://www.discuz.net" target="_blank" style="color: #09C; text-decoration: none;">CrossdayBoard</a> 论坛系统<span id="sp_midtext" style="color: #666;">(简称 <strong id="sp_notice" style="color: #F60;">Discuz!</strong> 论坛)</span>是一个采用 PHP 和 MySQL 等其他多种数据库构建的高效建站解决方案。</p>',
	...
	'styles_import_ignore_version' => '允许导入老版本的界面(易产生错误!!)',
	...
	'members_ipban_input_tips' => '<li>此操作需要在管理组内开启相关权限，只有站点管理员可以使用。</li><li>可以使用以前导出的禁止IP列表，也可以手动编写以便批量禁止IP。</li><li>你可以 <a href="eyun_admins.php?action=members&operation=ipban&ipact=output">导出现有禁止IP库</a></li>',
	...
	'members_profile_edit_showinthread_comment' => '选择是，还需在<a href="eyun_admins.php?action=setting&operation=styles&anchor=viewthread" target="_blank">帖子内容页</a>中选择展示位置',
	...
	'admingroup' => '管理组',
	'admingroup_tips' => '<li>管理组包括管理员、超级版主、版主三个内置管理组以及自定义管理组。</li>',
	...
	'usergroups_tips' => '<li>用户组分为系统组、会员组和自定义组，会员组以积分确定组别和权限，而系统组和自定义组是人为设定，不会由系统自行改变。</li><li>系统组和自定义组的设定不需要指定积分，预留了从站点管理员到游客等的 8 个系统头衔，自定义组的用户需要在编辑会员时将其加入。</li><li>会员用户组至少分为两组，其积分下限分别为负值(任一负数)和 0，否则将导致部分用户无法与用户组匹配的问题。</li>',
	...
	'usergroups_edit_post_custom_bbcode' => '允许使用自定义代码',
	'usergroups_edit_post_custom_bbcode_comment' => '设置是否解析用户帖子中的自定义代码。注意: 自定义代码由管理团队成员在管理中心中自行定义，不包括系统内置的数十种代码',
	'usergroups_edit_post_bio_bbcode' => '允许自我介绍中使用代码',
	'usergroups_edit_post_bio_bbcode_comment' => '设置是否解析用户自我介绍中的代码',
	...
	'usergroups_edit_post_sig_bbcode' => '允许签名中使用代码',
	'usergroups_edit_post_sig_bbcode_comment' => '设置是否解析用户签名中的代码',
	...
	'quickquery_open_discuzcode' => '开启 所有版块代码',
	...
	'quickquery_close_discuzcode' => '关闭 所有版块代码',
	...
	'announce_message' => '内容',
	'announce_message_comment' => '<b>文字公告:</b> 直接输入公告内容，支持代码<br /><b>网址链接:</b> 请输入公告的链接地址如某个主题地址: http://xxx.xxx.xxx',
	...
	'misc_bbcode' => '自定义代码',
	'misc_bbcode_edit' => '编辑代码',
	'misc_bbcode_edit_tips' => '<li>只有在自定义代码可用并设置了图标文件时，具有“允许使用自定义代码”权限的用户组在发帖时才会看到相应自定义代码按钮。</li>',
	'misc_bbcode_tag' => '标签',
	...
	'misc_cron_tips' => '<li>计划任务是提供的一项使系统在规定时间自动执行某些特定任务的功能，在需要的情况下，您也可以方便的将其用于站点功能的扩展。</li><li>计划任务是与系统核心紧密关联的功能特性，不当的设置可能造成站点功能的隐患，严重时可能导致站点无法正常运行，因此请务必仅在您对计划任务特性十分了解，并明确知道正在做什么、有什么样后果的时候才自行添加或修改任务项目。</li><li>此处和其他功能不同，本功能中完全按照站点系统默认时差对时间进行设定和显示，而不会依据某一用户或管理员的时差设定而改变显示或设置的时间值。</li>',
	...
	'misc_cron_edit_tips' => '<li>您正在对系统内置的计划任务进行编辑，除非非常了解结构，否则强烈建议不要修改默认设置。</li><li>请在修改之前记录原有设置，不当的设置将可能导致站点出现不可预期的错误。</li>',
	...
	'plugins_import_ignore_version' => '允许导入老版本的插件(易产生错误!!)',
	...
	'ec_alipay' => '支付宝设置',
	'ec_alipay_tips' => '<li>“支付宝”(<a href="http://www.alipay.com" target="_blank">http://www.alipay.com</a>)是中国领先的网上支付平台，由全球最佳 B2B 公司阿里巴巴公司创建，为用户提供积分购买及论坛 B2C、C2C 交易平台。您只需进行简单的设置，即可使论坛内容和人气，真成为除广告收入外的重要利润来源，从而实现论坛的规模化经营。</li><li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用支付宝积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。支付宝积分交易功能，需在“<a href="'.$BASESCRIPT.'?action=setting&operation=credits" target="_blank">积分设置</a>”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款支付宝账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除官方网站或官方论坛另行通知以外，Discuz! 提供的支付宝支付服务每笔交易收取 1.5% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以官方网站或官方论坛提供的信息为准。</li><li>您使用支付宝服务是建立在完全自愿的基础上，除因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。</li><li>支付宝业务咨询 Email 为 <a href="mailto:6688@taobao.com">6688@taobao.com</a>；支付宝客户服务电话为 +86-0571-88156688。</li>',
	...
	'ec_tenpay_tips' => '<li>“财付通”(<a href="http://www.tenpay.com" target="_blank">http://www.tenpay.com</a>)是腾讯公司创办的中国领先的在线支付平台，为用户提供积分购买交易平台。</li><li>如需启用积分充值即时到账，请使用财付通<b>企业版</b>并开通<b>即时到账交易</b>；否则，只需要开通“<b>中介担保交易</b>”即可。</li>
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以官方网站或官方论坛提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
	...
	'project_option_forum_allowbbcode' => '允许使用代码',
	...
	'project_option_group_allowsigbbcode' => '允许签名中使用代码',
	...
	'project_option_group_allowbiobbcode' => '允许自我介绍中使用代码',
	...
	'filecheck_tips_step1' => '文件校验是针对官方发布的文件为基础进行核对，点击下面按钮开始进行校验',
	...
	'hookcheck_tips_step1' => '嵌入点校验是针对官方发布的文件为基础进行核对，点击下面按钮开始进行校验{template}',
	...
	'dbcheck_tips' => '<li>数据库校验只针对官方发布的数据库结构为基础进行核对</li><li>此工具只对字段的修改以及缺少进行简单的检查，不针对索引的缺少进行处理。</li>',
	'dbcheck_field' => '错误的字段',
	...
	'db_import' => '数据恢复',
	'db_import_confirm' => '导入和当前版本不一致的数据极有可能产生无法解决的故障，您确定继续吗？',
	'db_import_confirm_sql' => '您确定导入该备份吗？',
	'db_import_confirm_zip' => '您确定解压该备份吗？',
	'db_import_tips' => '<li>本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定恢复前已将论坛关闭，恢复全部完成后可以将论坛重新开放。</li><li>恢复数据前请在X2.5 安装文件目录下utility文件夹内找到 restore.php 文件，然后将 restore.php 文件上传到程序文件夹data目录下。<b>为了您站点的安全，成功恢复数据后请务必及时删除 restore.php 文件。</b></li><li>您可以在数据备份记录处查看站点的备份文件的详细信息，删除过期的备份,并导入需要的备份。</li>',
	...
	'blockxml_import_ignore_version' => '允许添加老版本的 第三方模块(易产生错误!!)',
	...
	'setting_manyou_search_status_comment' => '漫游搜索是专为产品量身定做的高效、全文搜索服务，无须网站的 MySQL 资源',
