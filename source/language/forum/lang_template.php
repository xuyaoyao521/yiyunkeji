...
$lang = array (
  ...
  'mod_notice' => '论坛管理员在“管理面板”中权限和超级版主基本相同，如果需要更多功能，请进入 <a href="eyun_admins.php?mod=forum" target="_blank"><u>管理中心</u></a> ',
  ...
  'attach_nopermission_login' => '您需要 <a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href);return false;">登录</a> 才可以查看或下载！',
