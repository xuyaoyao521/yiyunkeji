...
if($_G['cookie']['HD_CITY'] && $zones[$_G['cookie']['HD_CITY']]){
	...
	if($city){
		...
		$city = defined('HD_CITY') && (HD_CITY !== '') ? HD_CITY : showmessage('dzapp_haodai:pleasechoosecity', 'eyun_admins.php?action=plugins&operation=config&identifier=dzapp_haodai&pmod=admincp_city');
