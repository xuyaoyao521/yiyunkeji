...
if(!$_GET['want']){
	showtableheader($lang['callback_info'].' <a href="eyun_admins.php?action=plugins&operation=config&identifier=dzapp_haodai&pmod=admincp_callback&want=import">['.$lang['click_to_import'].']</a>');
