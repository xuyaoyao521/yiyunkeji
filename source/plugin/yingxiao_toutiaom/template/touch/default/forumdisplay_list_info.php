...
<div class="item_info">
    ...
    <span class="cmt space">{echo p_lang('views')}&nbsp;<!--{if $thread[views] > 0}-->{$thread[views]}<!--{else}-->0<!--{/if}--></span>
    <span class="cmt space">{echo p_lang('reply')}&nbsp;<!--{if $thread[replies] > 0}-->{$thread[replies]}<!--{else}-->0<!--{/if}--></span>
