...
$count = C::t('home_favorite')->count_by_uid_idtype($_G['uid'], $idtype, $favid);
	...
	$count = C::t('home_favorite')->count_by_uid_idtype2($_G['uid'], $idtype, $favid);
}
...
if($count) {
	...
	foreach(C::t('home_favorite')->fetch_all_by_uid_idtype($_G['uid'], $idtype, $favid, $start,$perpage) as $value) {
		...
		foreach(C::t('home_favorite')->fetch_all_by_uid_idtype2($_G['uid'], $idtype, $favid, $start,$perpage) as $value) {
