<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); define('TEMP_APP', DISCUZ_ROOT.'./template/pc/ceo/');?><?php require_once(TEMP_APP.'ceo_lang.php');?><?php require_once(TEMP_APP.'ceo_function.php');?><?php require_once(TEMP_APP.'ceo_duanzi.php');?><ul class="Satin_list" id="alist">
    <?php if($toutiaolist) { ?>
   

      
            <?php include template('ceo/forum_duanzi'); ?>        
       



    <?php } else { ?>
    <li class="wmt">当前频道暂时没有段子</li>
    <?php } ?>
...
<script src="template/pc/ceo/ceo_ajaxpageduanzi.js" type="text/javascript"></script>
