...
<!--frame_footer-->
<div class="frame_footer" <?php if($_GET['isadmin']==1) { ?>style="display:none"<?php } ?>>
<div class="public_width font_yahei">
    	<div class="friendly_links">
        	<ul>
            <?php block_display('102');?>            </ul>
        </div>
        
        <p>&copy; 2016  <a href="#">weihaitoutiao.com</a>&nbsp;&nbsp;中国互联网举报中心 京ICP证140141号</p>
        <p>京ICP备12025439号-3 网络文化经营许可证</p>
        
       <!-- <div class="footer_logo"><a href="/"><img src="/public/images/logo.png"></a></div>-->
    </div>
...
<?php } ?>
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/ceo_nav.js" type="text/javascript"></script>
...
<?php } output();?><script src="/public/js/Public_index.js" type="text/javascript"></script>
</body>
</html>
