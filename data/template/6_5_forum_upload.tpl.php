...
<p class="xg1 mtn">
<?php if($type == 'image') { ?>可用扩展名: <span class="xi1"><?php echo $imgexts;?></span><?php } elseif($type == 'video') { ?>可用扩展名: <span class="xi1"><?php echo $imgexts;?></span><?php } elseif($_G['group']['attachextensions']) { ?>可用扩展名: <span class="xi1"><?php echo $_G['group']['attachextensions'];?></span><?php } ?>
</p>
