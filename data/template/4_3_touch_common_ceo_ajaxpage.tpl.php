<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); if($ceo_norepages == 2) { ?> 
<div class="a_pg box_bg" id="a_pg">
    <div id="ajaxld"><?php echo m_lang('load_pic'); ?></div>
    <div id="ajnt" style="display:none;"><a href="javascript:" ><?php echo m_lang('load'); ?></a></div>
    <div id="ajaxlast" style="display:none;"><a href="javascript:" ><?php echo m_lang('load_last'); ?></a></div>
</div>
...
<div class="a_pg" id="a_pg">
    <div id="ajaxld" style="display:none;"><?php echo m_lang('load_pic'); ?></div>
    <div id="ajaxlast" style="display:none;"><a href="javascript:" ><?php echo m_lang('load_last'); ?></a></div>
</div>
<script type="text/javascript">
$(document).ready(function(){
