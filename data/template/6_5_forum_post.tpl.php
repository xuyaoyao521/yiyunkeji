...
0
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_extra.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_body.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_attribute.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/seccheck_post.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor_menu.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/editor_menu_forum.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/upload.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/seccheck.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1478326350, '5', './data/template/6_5_forum_post.tpl.php', './template/pc', 'forum/post')
;?><?php include template('common/header'); ?><script src="static/js/forum.js?<?php echo VERHASH;?>" type="text/javascript" type="text/javascript"></script>
...
EOF;
?><?php $adveditor = $isfirstpost && $special || $special == 2 && ($_GET['action'] == 'newthread' || $_GET['action'] == 'reply' && !empty($_GET['addtrade']) || $_GET['action'] == 'edit' && $thread['special'] == 2);?><?php $advmore = !$showthreadsorts && !$special || $_GET['action'] == 'reply' && empty($_GET['addtrade']) || $_GET['action'] == 'edit' && !$isfirstpost && ($thread['special'] == 2 && !$special || $thread['special'] != 2);?><form method="post" autocomplete="off" id="postform"
...
<ul class="tb cl mbw" style="display:none">
...
<span><input type="text" name="subject" id="subject" class="px" value="<?php echo $postinfo['subject'];?>" <?php if($_GET['action'] == 'newthread') { ?>onblur="if($('tags')){relatekw('-1','-1'<?php if($_G['group']['allowposttag']) { ?>,function(){extraCheck(4)}<?php } ?>);doane();}"<?php } ?> onkeyup="strLenCalc(this, 'checklen', 255);" style="width: 25em" tabindex="1" /></span>
<?php } else { ?>
<span id="subjecthide" class="z">RE: <?php echo $thread['subject'];?> [<a href="javascript:;" onclick="display('subjecthide');display('subjectbox');$('subject').value='RE: <?php echo dhtmlspecialchars(str_replace('\'', '\\\'', $thread['subject'])); ?>';display('subjectchk');strLenCalc($('subject'), 'checklen', 255);return false;">修改</a>]</span>
<span id="subjectbox" style="display:none"><input type="text" name="subject" id="subject" class="px" value="" onkeyup="strLenCalc(this, 'checklen', 255);" style="width: 25em" /></span>
<?php } ?>			
<span id="subjectchk"<?php if($_GET['action'] == 'reply') { ?> style="display:none"<?php } ?>>还可输入 <strong id="checklen">255</strong> 个字符</span>
<script type="text/javascript">strLenCalc($('subject'), 'checklen', 255)</script>
...
<?php } if($_GET['type']!=arc) { ?>
<div id="<?php echo $editorid;?>_body_loading"><img src="<?php echo IMGDIR;?>/loading.gif" width="16" height="16" class="vm" /> 请稍后 ...</div>
...
<textarea name="<?php echo $editor['textarea'];?>" id="<?php echo $editorid;?>_textarea" class="pt" rows="15" tabindex="2"><?php echo $editor['value'];?></textarea>
   ...
   <link rel="stylesheet" type="text/css" href='<?php echo $_G['setting']['csspath'];?><?php echo STYLEID;?>_editor.css?<?php echo VERHASH;?>' />
...
<?php } ?>
 ...
 <?php } else { ?>
     <div class="area222">
<textarea name="<?php echo $editor['textarea'];?>"  class="pt" rows="5" tabindex="2" style="width:50%"><?php echo $editor['value'];?></textarea>
</div>
    
     <?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['post_middle'])) echo $_G['setting']['pluginhooks']['post_middle'];?>
<?php if($_GET['type']!=arc) { ?><div id="post_extra" class="ptm cl">
...
<?php if($_GET['action'] == 'newthread') { if($special == 0) { ?><span>发表</span>
...
<span><?php if($buttontext) { ?><?php echo $buttontext;?><?php } else { ?>发表<?php } ?></span>
