...
0
|| checktplrefresh('./template/pc/forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1478274283, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/pc', 'forum/viewthread')
|| checktplrefresh('./template/pc/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1478274283, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/pc', 'forum/viewthread')
|| checktplrefresh('./template/pc/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1478274283, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/pc', 'forum/viewthread')
|| checktplrefresh('./template/pc/forum/viewthread.htm', './template/default/common/seditor.htm', 1478274283, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/pc', 'forum/viewthread')
|| checktplrefresh('./template/pc/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1478274283, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/pc', 'forum/viewthread')
|| checktplrefresh('./template/pc/forum/viewthread.htm', './template/default/common/upload.htm', 1478274283, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/pc', 'forum/viewthread')
|| checktplrefresh('./template/pc/forum/viewthread.htm', './template/default/common/seccheck.htm', 1478274283, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/pc', 'forum/viewthread')
...
<div class="z">
<a href="./" title="首页"><?php echo $_G['setting']['bbname'];?></a> <?php echo $navigation;?> <em>&rsaquo;</em> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>"><?php echo $_G['forum_thread']['short_subject'];?></a>
</div>
</div>
...
<div id="postlist" class="pl ceo_view">
...
<div class="pi">
<div class="authi"><?php echo $post['author'];?> <?php echo $authorverifys;?></div>
</div>
<?php } ?>
...
<?php } ?>
<div class="avatar"<?php if(!($_G['setting']['threadguestlite'] && !$_G['uid'])) { ?> onmouseover="showauthor(this, 'userinfo<?php echo $post['pid'];?>')"<?php } ?>><?php echo $post['avatar'];?></div>
<?php } ?>
...
<a href="<?php if($_G['adminid'] == 1) { ?>eyun_admins.php?frames=yes&action=members&operation=search&uid=<?php echo $post['authorid'];?>&submit=yes<?php } else { ?>forum.php?mod=modcp&action=member&op=edit&uid=<?php echo $post['authorid'];?><?php } ?>" target="_blank">编辑</a>
<?php } if($_G['group']['allowbanuser']) { if($_G['adminid'] == 1) { ?>
<a href="eyun_admins.php?action=members&amp;operation=ban&amp;username=<?php echo $post['usernameenc'];?>&amp;frames=yes" target="_blank">禁止</a>
<?php } else { ?>
...
<a  target="_blank" class="xi2 z" style="padding-right:10px;"><?php echo avatar($post['authorid'], 'small'); ?></a>
...
<?php } if(!$_G['setting']['authoronleft']) { ?><?php echo $post['author'];?> <?php echo $authorverifys;?><?php } if($close_leftinfo) { } ?>
<em id="authorposton<?php echo $post['pid'];?>">发表于 <?php echo $post['dateline'];?></em>
                    
                    <span class="xg1"><?php if($post['status'] & 8) { ?>来自手机端<?php } else { ?>来自PC电脑端<?php } ?></span>
...
<p>您需要 <a href="member.php?mod=logging&amp;action=login" onclick="showWindow('login', this.href);return false;">登录</a> 才可以查看或下载！ <?php if(!empty($_G['setting']['pluginhooks']['global_login_text'])) echo $_G['setting']['pluginhooks']['global_login_text'];?></p>
</div>
...
<p><?php if($_G['uid']) { ?>您所在的用户组无法下载或查看附件<?php } elseif($_G['connectguest']) { ?>您需要 <a href="member.php?mod=connect" class="xi2">完善帐号信息</a> 或 <a href="member.php?mod=connect&amp;ac=bind" class="xi2">绑定已有帐号</a> 后才可以下载或查看<?php } else { ?>您需要 <a href="member.php?mod=logging&amp;action=login" onclick="showWindow('login', this.href);return false;">登录</a> 才可以查看或下载！ <?php if(!empty($_G['setting']['pluginhooks']['global_login_text'])) echo $_G['setting']['pluginhooks']['global_login_text'];?><?php } ?></p>
</div>
<span class="atips_close" onclick="this.parentNode.style.display='none'">x</span>
</div>
...
.bdsharebuttonbox{position:relative; top:-5px; float:left}
.tshare b{ float:left}
#p_btn{ padding:0}
</style>
<div class="tshare cl">
<b>分享到:&nbsp;</b>
<span class="bdsharebuttonbox"><a href="#" class="bds_sqq" data-cmd="sqq" title="分享到QQ好友"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a></span>
</div>
