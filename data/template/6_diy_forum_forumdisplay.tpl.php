...
0
|| checktplrefresh('./template/pc/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1478229003, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/pc', 'forum/forumdisplay')
|| checktplrefresh('./template/pc/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1478229003, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/pc', 'forum/forumdisplay')
|| checktplrefresh('./template/pc/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1478229003, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/pc', 'forum/forumdisplay')
|| checktplrefresh('./template/pc/forum/forumdisplay.htm', './template/pc/forum/forumdisplay_list.htm', 1478229003, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/pc', 'forum/forumdisplay')
|| checktplrefresh('./template/pc/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1478229003, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/pc', 'forum/forumdisplay')
|| checktplrefresh('./template/pc/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1478229003, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/pc', 'forum/forumdisplay')
|| checktplrefresh('./template/pc/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1478229003, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/pc', 'forum/forumdisplay')
...
<span class="y">
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum&amp;formhash=<?php echo FORMHASH;?>" id="a_favorite"  onclick="showWindow(this.id, this.href, 'get', 0);">收藏本版 <strong class="xi1" id="number_favorite" <?php if(!$_G['forum']['favtimes']) { ?> style="display:none;"<?php } ?>>(<span id="number_favorite_num"><?php echo $_G['forum']['favtimes'];?></span>)</strong></a>

<?php if(!empty($forumarchive)) { ?>
<span class="pipe">|</span><a id="forumarchive" href="javascript:;" onmouseover="showMenu(this.id)"><?php if($_GET['archiveid']) { ?><?php echo $forumarchive[$_GET['archiveid']]['displayname'];?><?php } else { ?>存档<?php } ?></a>
<?php } ?>
...
<span class="pipe">|</span><a href="<?php if($_G['adminid'] == 1) { ?>eyun_admins.php?mod=forum&action=recyclebin&frames=yes<?php } elseif($_G['forum']['ismoderator']) { ?>forum.php?mod=modcp&action=recyclebin&fid=<?php echo $_G['fid'];?><?php } ?>"  target="_blank">回收站</a>
<?php } ?>
...
<div class="boardnav">
<div id="ct" class="ceo_list wp cl<?php if($_G['forum']['allowside']) { ?> ct2<?php } ?>"<?php if($leftside) { ?> style="margin-left:<?php echo $_G['leftsidewidth_mwidth'];?>px"<?php } ?>>
<?php if($leftside) { ?>
...
<div class="mn" <?php if($leftside) { ?> style="width:auto;"<?php } ?>>
<div class="bp">
<?php if($_G['forum']['banner'] && !$subforumonly) { ?><img src="<?php echo $_G['forum']['banner'];?>" alt="<?php echo $_G['forum']['name'];?>" /><?php } ?>
<div class="listTit cl">
<a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>" class="post_btn">发表新帖</a>    
<?php if($moderatedby) { ?><div class="y">版主: <span class="xi2"><?php echo $moderatedby;?></span></div><?php } ?>
<h1 class="z"><img alt="<?php echo $_G['forum']['name'];?>" src="<?php if($_G['forum']['icon']) { ?>data/attachment/common/<?php echo $_G['forum']['icon'];?><?php } else { ?>static/image/common/forum.gif<?php } ?>"><?php echo $_G['forum']['name'];?></h1>
<div class="ceo_stat z">
<?php if(!$subforumonly) { ?>今日: <span><?php echo $_G['forum']['todayposts'];?></span><?php if($_G['forum']['todayposts']) { if($_G['forum']['todayposts'] < $_G['forum']['yesterdayposts']) { ?><b class="ico_fall">&nbsp;</b><?php } else { ?><b class="ico_increase">&nbsp;</b><?php } } ?><span class="pipe">|</span>主题: <span><?php echo $_G['forum']['threads'];?></span><?php if($_G['forum']['rank']) { ?><span class="pipe">|</span>排名: <span title="上次排名:<?php echo $_G['forum']['oldrank'];?>"><?php echo $_G['forum']['rank'];?></span><?php } } ?>
</div>
</div>
...
<div class="domain">本版域名: <a href="http://<?php echo $_G['forum']['domain'];?>.<?php echo $_G['setting']['domain']['root']['forum'];?>" id="group_link">http://<?php echo $_G['forum']['domain'];?>.<?php echo $_G['setting']['domain']['root']['forum'];?></a></div>
<?php } ?>						
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?><?php if($_G['forum']['threadsorts']['defaultshow']) { ?>&amp;filter=sortall&amp;sortall=1<?php } if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">全部
...
<ul id="thread_sorts" class="ttp cl"><?php if(is_array($_G['forum']['threadsorts']['types'])) foreach($_G['forum']['threadsorts']['types'] as $id => $name) { if($_GET['sortid'] == $id) { ?>
...
<?php if(empty($_G['forum']['sortmode'])) { ?><div id="threadlist" class="ceo_tl bp"<?php if($_G['uid']) { ?> style="position: relative;"<?php } ?>>
...
<?php } ?>
<a id="filter_special" href="javascript:;" class="allpost_ico xi2<?php if($_GET['specialtype']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)">
<span class="showmenu"><?php if($_GET['specialtype'] == 'poll') { ?>投票<?php } elseif($_GET['specialtype'] == 'trade') { ?>商品<?php } elseif($_GET['specialtype'] == 'reward') { ?>悬赏<?php } elseif($_GET['specialtype'] == 'activity') { ?>活动<?php } elseif($_GET['specialtype'] == 'debate') { ?>辩论<?php } else { ?>全部主题<?php } ?></span>
</a>

<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=lastpost&amp;orderby=lastpost<?php echo $forumdisplayadd['lastpost'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="lastpost_ico xi2<?php if($_GET['filter'] == 'lastpost') { ?> xw1<?php } ?>">
最新
</a>
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=hot" class="hotpost_ico xi2<?php if($_GET['filter'] == 'hot') { ?> xw1<?php } ?>">
热帖
</a>

<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=digest&amp;digest=1<?php echo $forumdisplayadd['digest'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="digestpost_ico xi2<?php if($_GET['filter'] == 'digest') { ?> xw1<?php } ?>">
精华
</a>
...
<?php } else { ?>
<td class="by">
<a<?php if(empty($_G['cookie']['forumdefstyle'])) { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=yes" class="chked y"<?php } else { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=no" class="unchk y"<?php } ?> title="图片模式浏览帖子">图片模式</a>
</td>
<?php } ?>
</tr>
</table>
...
<tbody>
<tr>
<td class="h_avatar"><img src="<?php echo IMGDIR;?>/ann_icon.gif" alt="公告" /></td>
<?php if($_G['forum']['ismoderator'] && !$_GET['archiveid']) { ?><td class="o">&nbsp;</td><?php } ?>
<th class="common">
<div class="y">
<cite><<?php echo $announcement['author'];?></cite>
<em style="color:#aaa;"><?php echo $announcement['starttime'];?></em>
</div>
...
<tbody id="separatorline" class="emptb"><tr><td class="h_avatar"></td><?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?><td class="o"></td><?php } ?><th></th><?php if(CURMODULE == 'guide') { ?><td class="by"></td><?php } ?><td></td><td></td><td></td></tr></tbody>
...
<th><?php if(empty($_G['forum']['picstyle']) && $_GET['orderby'] == 'lastpost' && !$_GET['filter']) { ?><a href="javascript:;" onclick="checkForumnew_btn('<?php echo $_G['fid'];?>')" title="查看更新" class="forumrefresh">版块主题</a><?php } else { ?>&nbsp;<?php } ?></th>
<td class="w1"></td>
<td class="w1"></td>
<td class="w1"></td>
</tr>
...
<tr>
<td class="h_avatar"><?php echo avatar($thread[authorid],small);?></td>
...
<h3>
<?php if(in_array($thread['displayorder'], array(1, 2, 3, 4))) { ?>
<img class="zd" src="<?php echo IMGDIR;?>/pin_<?php echo $thread['displayorder'];?>.gif" alt="<?php echo $_G['setting']['threadsticky'][3-$thread['displayorder']];?>" />
<?php } ?>
...
<?php if($thread['moved']) { ?>
移动:<?php $thread[tid]=$thread[closed];?>  
...
<div class="tl_txt cl">
<span class="replies y"><?php echo $thread['allreplies'];?></span>
<p class="publisher">
<?php if($thread['authorid'] && $thread['author']) { ?>
<?php echo $thread['author'];?><?php if(!empty($verify[$thread['authorid']])) { ?> <?php echo $verify[$thread['authorid']];?><?php } } else { ?>
<?php echo $_G['setting']['anonymoustext'];?>
<?php } ?> 于
<span<?php if($thread['istoday']) { ?> <?php } ?>><?php echo $thread['dateline'];?></span> 发布
</p>

<p class="replyer">
<?php if($thread['lastposter']) { ?><?php echo $thread['lastposter'];?><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?><?php } ?> 
最后回复 
...
<div class="desc">
<em><?php echo $thread['views'];?></em>  人气 /
<em><?php if($thread['recommends']) { ?><?php echo $thread['recommends'];?><?php } else { ?>0<?php } ?></em> 喜欢 / 
<em><?php echo $thread['replies'];?></em> 回复
</div>
<div class="auth cl">
<a class="z" href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" c="1"><?php echo avatar($thread[authorid],small);?> <?php echo $thread['author'];?> </a>
<p class="y"><?php echo $thread['dateline'];?></p>
</div>
</li>
<?php } ?>
</ul>
...
<div class="sd_btn bp"><!--[diy=diy_sd_btn]--><div id="diy_sd_btn" class="area"></div><!--[/diy]--></div>
<div class="mbm"><!--[diy=diy_ad11]--><div id="diy_ad11" class="area"></div><!--[/diy]--></div>
<div class="ceo_forum_hot bp"><!--[diy=diy_forum_hot]--><div id="diy_forum_hot" class="area"></div><!--[/diy]--></div>
<div class="mbm"><!--[diy=diy_ad12]--><div id="diy_ad12" class="area"></div><!--[/diy]--></div>
<div class="ceo_thread_top bp"><!--[diy=diy_thread_top]--><div id="diy_thread_top" class="area"></div><!--[/diy]--></div>
<div class="mbm"><!--[diy=diy_ad13]--><div id="diy_ad13" class="area"></div><!--[/diy]--></div>
<div class="ceo_act_hot bp"><!--[diy=diy_act_hot]--><div id="diy_act_hot" class="area"></div><!--[/diy]--></div>
<div class="mbm"><!--[diy=diy_ad14]--><div id="diy_ad14" class="area"></div><!--[/diy]--></div>
<div class="ceo_rep_hot bp"><!--[diy=diy_rep_hot]--><div id="diy_rep_hot" class="area"></div><!--[/diy]--></div>
<div class="mbm"><!--[diy=diy_ad15]--><div id="diy_ad15" class="area"></div><!--[/diy]--></div>
<div class="ceo_users bp"><!--[diy=diy_users]--><div id="diy_users" class="area"></div><!--[/diy]--></div>
<div class="mbm"><!--[diy=diy_ad16]--><div id="diy_ad16" class="area"></div><!--[/diy]--></div>
<div class="ceo_follow bp"><!--[diy=diy_follow]--><div id="diy_follow" class="area"></div><!--[/diy]--></div>
<div class="mbm"><!--[diy=diy_ad18]--><div id="diy_ad18" class="area"></div><!--[/diy]--></div>
...
<?php if(!$_G['forum']['allowspecialonly']) { ?><li><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>">发表</a></li><?php } if($_G['forum']['threadsorts'] && !$_G['forum']['allowspecialonly']) { if(is_array($_G['forum']['threadsorts']['types'])) foreach($_G['forum']['threadsorts']['types'] as $id => $threadsorts) { if($_G['forum']['threadsorts']['show'][$id]) { ?>
