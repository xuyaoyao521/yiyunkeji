<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('forun_duanzi');
0
|| checktplrefresh('./template/pc/forum/forun_duanzi.htm', './template/pc/forum/viewthread_arcfastpost.htm', 1477446910, '5', './data/template/6_5_forum_forun_duanzi.tpl.php', './template/pc', 'forum/forun_duanzi')
|| checktplrefresh('./template/pc/forum/forun_duanzi.htm', './template/pc/forum/viewthread_node_arc.htm', 1477446910, '5', './data/template/6_5_forum_forun_duanzi.tpl.php', './template/pc', 'forum/forun_duanzi')
...
<div class="frame_main public_width font_yahei text"><?php include template('common/left_menu'); ?><div class="left">
    	<div class="Hot_satin">
            ...
            <ul class="main">
              ...
              <?php if(is_array($duanzilist)) foreach($duanzilist as $list) { ?>            	<li>
                	<p><a href="home.php?mod=auther&amp;uid=<?php echo $list['authorid'];?>"><img src="uc_server/avatar.php?uid=<?php echo $list['authorid'];?>&amp;size=middle"><?php echo $list['author'];?></a></p>
                    <p><a href="forum.php?mod=viewthread&amp;tid=<?php echo $list['tid'];?>"><?php echo $thread['message'];?></a></p>
                    <p><a href="forum.php?mod=viewthread&amp;tid=<?php echo $list['tid'];?>" class="evaluate"><?php if($thread['replies'] > 0) { ?><?php echo $list['replies'];?><?php } else { ?>0<?php } ?>评价</a><a href="javascript:;" class="praise <?php echo $list['zanguo'];?>" onClick="forumzan(<?php echo $list['tid'];?>,1,this)"><?php echo $list['ding'];?></a></p>
                </li>
               <?php } ?>
            </ul>
        </div>
    ...
    <div class="right">
        ...
        <div class="details_main">
            ...
            <div class="details_Satin_content"><?php echo $thread['message'];?>
            
            </div>
            
            <div class="praise_despise"><a href="javascript:;" class="praise <?php echo $zanguo;?>" onClick="forumzan(<?php echo $thread['tid'];?>,1,this)"><?php echo $thread['ding'];?></a><a href="javascript:;" class="despise <?php echo $bishiguo;?>" onClick="forumzan(<?php echo $thread['tid'];?>,2,this)"><?php echo $thread['bishi'];?></a></div>
            
             <div class="details_function">
             <p class="details_author"><a href="home.php?mod=auther&amp;uid=<?php echo $thread['authorid'];?>"><img src="uc_server/avatar.php?uid=<?php echo $thread['authorid'];?>&amp;size=middle"><?php echo $thread['author'];?></a><span class="time"><?php echo $thread['dateline'];?></span><?php if($post['authorid'] != $_G['uid']) { ?>
