...
0
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/home/space_pm_node.htm', 1477389165, 'diy', './data/template/6_diy_home_space_pm.tpl.php', './template/pc', 'home/space_pm')
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/common/seditor.htm', 1477389165, 'diy', './data/template/6_diy_home_space_pm.tpl.php', './template/pc', 'home/space_pm')
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/home/space_prompt_nav.htm', 1477389165, 'diy', './data/template/6_diy_home_space_pm.tpl.php', './template/pc', 'home/space_pm')
;?>
<?php $_G['home_tpl_titles'] = array('短消息');?><?php include template('common/header_home'); ?><style id="diy_style" type="text/css"></style>
<div class="wp">
...
<li<?php echo $actives['privatepm'];?> <?php echo $actives['newpm'];?>><a href="home.php?mod=space&amp;do=pm&amp;filter=privatepm">私人消息</a></li>
  ...
  <li class="o"&nbsp; style="float:right;"><a href="home.php?mod=spacecp&amp;ac=pm">发送消息</a></li>
</ul>
...
<dd class="ptm">
<form id="pmform" name="pmform" method="post" autocomplete="off" action="home.php?mod=spacecp&amp;ac=pm&amp;op=send&amp;pmid=<?php echo $pmid;?>&amp;daterange=<?php echo $daterange;?>&amp;handlekey=pmsend&amp;pmsubmit=yes" onsubmit="this.message.value = parseurl(this.message.value);ajaxpost('pmform', 'pmforum_return', 'pmforum_return');history.go(0);return false;">
<div class="tedt">
<div class="bar">
...
<?php } else { ?>
<a class="xw1"><?php echo $value['tousername'];?></a> 对 <span class="xi2">您</span> 说 :<br />
<?php } ?>
<?php echo $value['lastsummary'];?> &nbsp;  <br />
<span class="xg1"><?php echo dgmdate($value[lastdateline], 'u');?></span> &nbsp; 
<span class="pm_o y" style="text-align:right">
...
<h2 class="mt bbda">我的消息</h2>
<ul>
<li <?php echo $opactives['pm'];?>><a href="home.php?mod=space&amp;do=pm" <?php if($_GET['do']=='pm') { ?>class="on"<?php } ?>>消息 <?php if($newpmcount) { ?><strong class="xi1">(<?php echo $newpmcount;?>)</strong><?php } ?></a></li>   <li <?php echo $opactives['pm'];?>><a href="home.php?mod=space&amp;do=notice&amp;view=system" <?php if($_GET['do']=='notice'&&$_GET['view']=='system') { ?>class="on"<?php } ?>>系统</a></li>
        <li <?php echo $opactives['pm'];?>><a href="home.php?mod=space&amp;do=notice" <?php if($_GET['do']=='notice'&&!$_GET['view']) { ?>class="on"<?php } ?>>提醒</a></li>
