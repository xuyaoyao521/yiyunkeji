...
0
|| checktplrefresh('./template/default/home/space_notice.htm', './template/default/home/space_prompt_nav.htm', 1477389129, 'diy', './data/template/6_diy_home_space_notice.tpl.php', './template/pc', 'home/space_notice')
;?>
<?php $_G['home_tpl_titles'] = array('提醒');?><?php include template('common/header_home'); ?><style id="diy_style" type="text/css"></style>
<div class="wp">
