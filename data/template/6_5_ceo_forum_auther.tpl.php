...
0
|| checktplrefresh('./template/pc/ceo/forum_auther.htm', './template/pc/ceo/forumdisplay_list_pic.htm', 1477886245, '5', './data/template/6_5_ceo_forum_auther.tpl.php', './template/pc', 'ceo/forum_auther')
;?>

        <?php $i = 0;?>        <?php if(is_array($toutiaolist2)) foreach($toutiaolist2 as $thread) { ?>            <?php $i++;?>            <li>
