...
block_get('104,105,106,109,110,103');?><?php include template('common/header'); if(empty($gid)) { ?><?php echo adshow("text/wp a_t");?><?php } ?>
...
<div id="ct" class="ceo_forum wp cl<?php if($_G['setting']['forumallowside']) { ?> ct2<?php } ?> public_width" style="margin-top:30px;">
<!--[diy=diy_chart]--><div id="diy_chart" class="area"></div><!--[/diy]-->
    <?php include template('common/left_menu'); ?>    
...
<div class="drag"><!--[diy=diy2]--><div id="diy2" class="area"></div><!--[/diy]--></div>
        <div class="sd_btn bp"><!--[diy=diy_sd_btn]--><div id="diy_sd_btn" class="area"><div id="framez1P1mY" class="frame move-span cl frame-1"><div id="framez1P1mY_left" class="column frame-1-c"><div id="framez1P1mY_left_temp" class="move-span temp"></div><?php block_display('104');?></div></div></div><!--[/diy]--></div>
            <div class="mbm"><!--[diy=diy_ad11]--><div id="diy_ad11" class="area"></div><!--[/diy]--></div>
        <div class="ceo_forum_hot bp"><!--[diy=diy_forum_hot]--><div id="diy_forum_hot" class="area"><div id="frameXcN6QY" class="frame move-span cl frame-1"><div id="frameXcN6QY_left" class="column frame-1-c"><div id="frameXcN6QY_left_temp" class="move-span temp"></div><?php block_display('105');?></div></div></div><!--[/diy]--></div>
            <div class="mbm"><!--[diy=diy_ad12]--><div id="diy_ad12" class="area"></div><!--[/diy]--></div>
        <div class="ceo_thread_top bp"><!--[diy=diy_thread_top]--><div id="diy_thread_top" class="area"><div id="framem4cm4z" class="frame move-span cl frame-1"><div id="framem4cm4z_left" class="column frame-1-c"><div id="framem4cm4z_left_temp" class="move-span temp"></div><?php block_display('106');?></div></div></div><!--[/diy]--></div>
        ...
        <div class="ceo_rep_hot bp"><!--[diy=diy_rep_hot]--><div id="diy_rep_hot" class="area"><div id="framerDNqMo" class="frame move-span cl frame-1"><div id="framerDNqMo_left" class="column frame-1-c"><div id="framerDNqMo_left_temp" class="move-span temp"></div><?php block_display('109');?></div></div></div><!--[/diy]--></div>
            <div class="mbm"><!--[diy=diy_ad15]--><div id="diy_ad15" class="area"></div><!--[/diy]--></div>
        <div class="ceo_users bp"><!--[diy=diy_users]--><div id="diy_users" class="area"><div id="frameKqQF16" class="frame move-span cl frame-1"><div id="frameKqQF16_left" class="column frame-1-c"><div id="frameKqQF16_left_temp" class="move-span temp"></div><?php block_display('110');?></div></div></div><!--[/diy]--></div>
...
<div class="mn" style="width:760px; float:right; margin-right:30px;">
        ...
        <div class="forum_slide bp"><!--[diy=diy_slide]--><div id="diy_slide" class="area"><div id="frameUT11MQ" class="frame move-span cl frame-1"><div id="frameUT11MQ_left" class="column frame-1-c"><div id="frameUT11MQ_left_temp" class="move-span temp"></div><?php block_display('103');?></div></div></div><!--[/diy]--></div>
...
<!--<div class="y">
<?php if($_G['cache']['userstats']['newsetuser']) { ?>欢迎新会员：<em><?php echo $_G['cache']['userstats']['newsetuser'];?></em><?php } ?>
</div>-->
</div>
<?php } ?>
...
<?php if(!empty($collectiondata['follows'])) { $forumscount = count($collectiondata['follows']);?><?php $forumcolumns = 4;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="ceo_forum_box bp <?php if($forumcolumns) { ?> flg<?php } ?> cl">
<div class="ceo_forum_tit cl">
...
<?php } if(empty($gid) && !empty($forum_favlist)) { $forumscount = count($forum_favlist);?><?php $forumcolumns = $forumscount > 3 ? ($forumscount == 4 ? 4 : 5) : 1;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="ceo_forum_box bp <?php if($forumcolumns) { ?> flg<?php } ?> cl">
<div class="ceo_forum_tit cl">
...
<div class="ceo_forum_box bp <?php if($cat['forumcolumns']) { ?> flg<?php } ?> cl">
...
</div><?php echo adshow("intercat/bm a_c/$cat[fid]");?><?php } if(!empty($collectiondata['data'])) { $forumscount = count($collectiondata['data']);?><?php $forumcolumns = 4;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="ceo_forum_box bp <?php if($forumcolumns) { ?> flg<?php } ?> cl">
<div class="ceo_forum_tit cl">
