...
0
|| checktplrefresh('./template/pc/ceo/forum.htm', './template/pc/ceo/forumdisplay_list_pic.htm', 1478328978, '5', './data/template/6_5_ceo_forum.tpl.php', './template/pc', 'ceo/forum')
;?>
        ...
        <?php $i = 0;?>        <?php if(is_array($toutiaolist)) foreach($toutiaolist as $thread) { ?>            <?php $i++;?>            <li>
            ...
            <?php if($thread['attachment'] == 2||$thread['fid']==40) { ?>
                ...
                <?php if($thread['piccount'] >= 1 && $thread['piccount'] < 4||$thread['fid']==40) { ?>
