...
0
|| checktplrefresh('./template/mobile/touch/common/header_default.htm', './template/mobile/touch/common/header_common.htm', 1477389531, '3', './data/template/4_3_touch_common_header_default.tpl.php', './template/mobile', 'touch/common/header_default')
|| checktplrefresh('./template/mobile/touch/common/header_default.htm', './template/mobile/touch/common/ceo_color.htm', 1477389531, '3', './data/template/4_3_touch_common_header_default.tpl.php', './template/mobile', 'touch/common/header_default')
;?>
...
<body id="nv_<?php echo $_G['basescript'];?>" class="pg_<?php echo CURMODULE;?><?php if($_G['basescript'] === 'portal' && CURMODULE === 'list' && !empty($cat)) { ?> <?php echo $cat['bodycss'];?><?php } ?>"><?php
$color_main = <<<EOF
