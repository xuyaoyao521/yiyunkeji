<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('forun_view');
0
|| checktplrefresh('./template/pc/forum/forun_view.htm', './template/pc/forum/viewthread_arcfastpost.htm', 1478318760, '5', './data/template/6_5_forum_forun_view.tpl.php', './template/pc', 'forum/forun_view')
|| checktplrefresh('./template/pc/forum/forun_view.htm', './template/pc/forum/viewthread_node_arc.htm', 1478318760, '5', './data/template/6_5_forum_forun_view.tpl.php', './template/pc', 'forum/forun_view')
|| checktplrefresh('./template/pc/forum/forun_view.htm', './template/pc/ceo/forumdisplay_list_pic.htm', 1478318760, '5', './data/template/6_5_forum_forun_view.tpl.php', './template/pc', 'forum/forun_view')
...
<?php } ?>
            ...
            <?php if($threadsortshow['optionlist']) { ?>
            <p class="details_tag">[摘要]&nbsp;<?php echo $threadsortshow['optionlist']['zhaiyao']['value'];?></p>
            <?php } ?>
