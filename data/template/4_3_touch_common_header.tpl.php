...
0
|| checktplrefresh('./template/mobile/touch/common/header.htm', './template/mobile/touch/common/header_common.htm', 1478304429, '3', './data/template/4_3_touch_common_header.tpl.php', './template/mobile', 'touch/common/header')
|| checktplrefresh('./template/mobile/touch/common/header.htm', './template/mobile/touch/common/ceo_color.htm', 1478304429, '3', './data/template/4_3_touch_common_header.tpl.php', './template/mobile', 'touch/common/header')
;?>
...
<header class="header_bg">
    ...
    <div id="home_backpage" class="backpage" style="display:none"><a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>&amp;do=profile&amp;mycenter=1" class="z"><i class="iconfont i_backpage">&#xe844;</i></a></div>
    <div id="userlogin" class="hd_mu">
    <?php if($_G['uid'] || $_G['connectguest']) { ?>
        <a id="us_list_btn" href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>&amp;do=profile&amp;mycenter=1" class="z avatar"><img src="<?php echo avatar($_G[uid], small, true);?>" class="uspic" /><i class="iconfont i_usermenu">&#xe812;</i></a>
    <?php } else { ?>    
    ...
    <div id="webtitle" class="logo"><a href="forum.php?mod=phone&amp;mobile=2"><img src="template/mobile/toutiao_mobile/img/logo.png" /></a></div>
    <div id="side_pr" class="hd_mu"><a href="search.php?mod=forum&amp;mobile=2"class="y"><i class="mobile_icon i_sidemenu" style="font-size:22px;">&#xe604;</i></a></div>
</header>
<div class="toptb" style=""></div><?php
$color_main = <<<EOF
