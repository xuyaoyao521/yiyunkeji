...
<!--{if $_GET['op'] == 'delete'}-->
	...
	<dd><input type="submit" name="deletesubmitbtn" value="{lang determine}" class="formdialog btn_default"></dd>
	</form>
<!--{else}-->
	...
	<dd><input type="submit" name="favoritesubmit_btn" id="favoritesubmit_btn"  value="{lang determine}" class="formdialog btn_default"><a href="javascript:;" onclick="popup.close();">{lang cancel}</a></dd>
	</form>
<!--{/if}-->
</div>
