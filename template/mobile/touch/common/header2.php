...
<body id="nv_{$_G[basescript]}" class="pg_{CURMODULE}{if $_G['basescript'] === 'portal' && CURMODULE === 'list' && !empty($cat)} {$cat['bodycss']}{/if}" onLoad="">
<div id="wp">
...
<header class="header_bg">
    ...
    <div id="forum_backpage" class="backpage" style="display:none"><a href="forum.php?mod=forumdisplay&fid=$_G[fid]" class="z"><i class="iconfont i_backpage">&#xe844;</i></a></div>
