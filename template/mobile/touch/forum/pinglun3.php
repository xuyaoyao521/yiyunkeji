        ...
        <!--{/if}-->
            ...
            <!--{/if}--><!--{/if}-->
                ...
                <div class="replybtn">
                    ...
                    <input type="button" value="删除"  onClick="delete_post($post[pid],$post[tid],this);"  class="btn_default">
					...
					<a href="javascript:;" onclick="plunzan($post[pid],this);return false;"><i class="iconfont">&#xf661;</i><!--{if $post[postreview][support]}--><span id="review_support_$post[pid]">$post[postreview][support]</span><!--{/if}--></a>
                </div>
                <!--div class="replybtn">
...
<!--{if $ceo_norepages > 1}-->    
    ...
    var pages=$_G['page'];
    var allpage={echo $thispage = ceil($commnetnum / $_G['ppp']);};
    </script>
