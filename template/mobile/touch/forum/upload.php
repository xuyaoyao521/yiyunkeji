<?php exit;?> 
<div class="post_upload" id="upfilecoose">
	<h3 class="flb">
		<em id="return_upload">{lang upload}</em>
		<em id="uploadwindowing" style="visibility:hidden"><img src="{IMGDIR}/uploading.gif" alt="" /></em>
	...
	<div class="c">
		<form id="uploadform" class="uploadform ptm pbm" method="post" autocomplete="off" target="uploadattachframe" onsubmit="uploadWindowstart()" action="misc.php?mod=swfupload&operation=upload&type=$type&inajax=yes&infloat=yes&simple=2" enctype="multipart/form-data">
			...
			<div class="filebtn">
				<input type="file" name="Filedata" id="filedata" class="pf cur1" size="1" onchange="ceo('uploadform').submit();" />
			</div>
		</form>
		<p class="xg1 mtn">
