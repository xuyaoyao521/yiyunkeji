...
<!--{if $op == 'ban' && $member && !$error}-->
	<form method="post" autocomplete="off" action="{$cpscript}?mod=modcp&action=$_GET[action]&op=$op&mobile=2" class="schresult">
        ...
        <div class="modcp_view box_bg box_brb mbm">
        ...
        <div class="modcp_edit box_bg box_br mbm">
            ...
            <p class="mtn"><input type="submit" name="bansubmit" id="submit"  value="{lang submit}" class="btn_default" /></p>
        </div>
	</form>
<!--{/if}-->

        <div class="modcp_so box_bg box_br">
<form method="post" autocomplete="off" action="{$cpscript}?mod=modcp&action=$_GET[action]&op=$op&mobile=2">
    ...
    <div>
        ...
        <p class="mtn">
        	<input type="submit" name="submit" id="searchsubmit"  value="{lang modcp_logs_search}" class="btn_default" />
        </p>
	</div>
	</div>
</form>
